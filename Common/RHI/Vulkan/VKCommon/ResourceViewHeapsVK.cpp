...
bool ResourceViewHeaps::AllocateDescriptor(VkDescriptorSetLayout descriptorLayout, VkDescriptorSet *pDescriptorSet)
{
    ...
    descSetAI.descriptorPool = mDescriptorPool;
    descSetAI.descriptorSetCount = 1;
    descSetAI.pSetLayouts = &descriptorLayout;

    VK_CHECK_RESULT(vkAllocateDescriptorSets(m_pDevice->GetDevice(), &descSetAI, pDescriptorSet));
...
bool ResourceViewHeaps::AllocateDescriptor(
    int size,
    ...
    VkDescriptorSet *pDescriptorSet)
{
    ...
    return AllocateDescriptor(*pDescSetLayout, pDescriptorSet);
}
